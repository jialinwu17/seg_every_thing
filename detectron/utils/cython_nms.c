...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/h1/jialinwu/.local/lib/python2.7/site-packages/numpy/core/include/numpy/arrayobject.h", 
            "/h1/jialinwu/.local/lib/python2.7/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ], 
        "extra_compile_args": [
            "-Wno-cpp"
        ], 
        "include_dirs": [
            "/h1/jialinwu/.local/lib/python2.7/site-packages/numpy/core/include"
        ], 
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(2, 0, 28, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_detectron_utils_cython_nms_pyx, __pyx_n_s_nms, 37, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 37, __pyx_L1_error)
